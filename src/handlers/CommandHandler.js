class CommandHandler {
	...
	async handle(message) {
		...
		// check if command is patrons only
			...
			return message.channel.createMessage(`❌ \`${command.name}\` is exclusive for patreon donators. Support Jeremy on patreon to get access: https://www.patreon.com/lootcord`)
		}
			...
			return message.channel.createMessage(`❌ \`${command.name}\` is exclusive for **Loot Hoarder**+ patreon donators. Support Jeremy on patreon to get access: https://www.patreon.com/lootcord`)
		}
