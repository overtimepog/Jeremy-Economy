module.exports = {
	...
	async execute(app, message, { args, prefix }) {
		...
		if (gambleAmount > row.scrap) {
			return message.reply(`❌ You don't have that much Scrap! You currently have **${app.common.formatNumber(row.scrap, false, true)}**. You can trade your ${app.icons.money} Racoin for ${app.icons.scrap} Scrap: \`${prefix}buy scrap <amount>\``)
		}
