...
module.exports = {
	name: 'convert',
	aliases: [''],
	description: 'Convert Jeremy Racoin to another bot\'s currency using Discoin.',
	long: 'Lvl Required: 3+\nConvert your Jeremy Racoin to another bot\'s currency using [Discoin](https://discoin.gitbook.io/docs/users-guide). You can find participating bots and their currency codes [here](https://dash.discoin.zws.im/#/currencies).',
	args: { amount: 'Amount of Racoin to convert.', currency: '3-Letter currency code of currency you want to convert to.' },
