...
module.exports = {
	...
	async execute(app, message, { args, prefix }) {
		...
		let description =`For details on using clan commands, you can type \`${prefix}clan help\`, or check this [link](https://lootcord.com/guides/clans).`

		converted.setDate(converted.getDate() + 10)

		const embed = new app.Embed()
			.setAuthor('Jeremy Commands', message.author.avatarURL)
