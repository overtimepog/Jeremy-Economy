module.exports = {
	name: 'addmod',
	aliases: [''],
	description: 'Makes user a Jeremy moderator.',
	long: 'Makes user a Jeremy moderator.',
	args: {
	...
	async execute(app, message, { args, prefix }) {
		...
		const modMsg = new app.Embed()
			...
			.setDescription('Use `j.modhelp` to see your fancy new commands!')
			.setFooter('You can use mod commands in the Jeremy Workshop moderator channel')
			.setColor(720640)
